...
# File: /Users/samschlinkert/Documents/code/flatiron/scratch/blog/app/views/posts/show.html.erb
# Starting at line number: 9... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/scratch/blog/app/views/posts/index.html.erb
# Starting at line number: 6... 

  <h1>Here's the posts index page!</h1>
...
# File: /Users/samschlinkert/Documents/code/flatiron/lectures/sinatra-blog-ruby-004/app/views/posts/index.html.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/lectures/rails-blog-ruby-004/app/views/posts/index.html.erb
# Starting at line number: 4... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/lectures/rails-blog-ruby-004/app/views/posts/_form.html.erb
# Starting at line number: 4... 

  <% if @post && @post.errors.any? %>
  <h2>Sorry! Your post isn't great. Here's why:</h2>
  <ul> 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week7/auction-app-team-cubs/app/views/auctions/index.html.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week7/auction-app-team-cubs/app/views/auctions/_form.html.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/the-big-todo-ruby-004/app/views/todo_lists/show.html.erb
...
<%= form_tag("/todo_lists/#{@todo.id}/tasks", method: "post") do %>
  <%= label_tag(:task_name, "New Task:") %>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/the-big-todo-ruby-004/app/views/todo_lists/index.html.erb
# Starting at line number: 1... 

  <% @todos.each do |todo| %>
<p><%= link_to todo.name, todo %></p>
<% end %>

<%= form_tag("/todo_lists", method: "post") do %>
  <%= label_tag(:todo_list_name, "New Todo:") %>
  <%= text_field_tag(:todo_list_name) %>
  <%= submit_tag("Create Todo list") %>
<% end %>


###########################

# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/tadpoles/index.erb
# Starting at line number: 4... 

  <%= erb :'layouts/header' %>

<h1>Tadpoles</h1>
<% @tadpoles.each do |tadpole| %>
  <p><a href="/tadpoles/<%= tadpole.id %>"><%= tadpole.name %></a></p>
<% end %>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/ponds/show.erb
# Starting at line number: 8... 

  <p>Resident frogs and their tadpoles:</p>
<ol>
  <% @pond.frogs.each do |frog| %>
    <li><a href="/frogs/<%= frog.id %>"><%= frog.name %> frog</a>
      <ol>
        <% frog.tadpoles.each do |tadpole| %>
          <li><a href="/tadpoles/<%= tadpole.id %>"><%= tadpole.name %> tadpole</a></li>
        <% end %>
      </ol>
    </li>
  <% end %>
...
<a href="/ponds">Back</a> | 
<a href="/ponds/<%= @pond.id %>/edit">Edit</a> | 
<a href="/ponds/<%= @pond.id %>/destroy">Delete</a>
...
# Starting at line number: 5... 
  ...
  <h1><%= @pond.name %> Pond</h1>
<p>water type: <%= @pond.water_type %></p>
<p>Resident frogs and their tadpoles:</p>
<ol>
  <% @pond.frogs.each do |frog| %>
    <li><a href="/frogs/<%= frog.id %>"><%= frog.name %> frog</a>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/ponds/index.erb
# Starting at line number: 4... 
...
<h1>Ponds</h1>
<% @ponds.each do |pond| %>
  <p><a href="/ponds/<%= pond.id %>"><%= pond.name %></a></p>
<% end %>
<p><a href="/ponds/new">Create a new pond</a></p>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/frogs/show.erb
# Starting at line number: 7... 

  <p>Color: <%= @frog.color %></p>
<p>Lives: <a href="/ponds/<%= @frog.pond.id %>"><%= @frog.pond.name %></a></p>
<% unless @frog.tadpoles.empty? %>
  <h2>Children</h2>
  <ol>
    <% @frog.tadpoles.each do |tadpole| %>
      <li><a href="/tadpoles/<%= tadpole.id %>"><%= tadpole.name %></a></li>
    <% end %>
  </ol><br>
<% end %>
<p><strong><a href="/frogs/<%= @frog.id %>/tadpoles/new">Create new tadpole baby</a></strong></p>
<a href="/frogs">Back</a> | 
<a href="/frogs/<%= @frog.id %>/edit">Edit</a> | 
<a href="/frogs/<%= @frog.id %>/destroy">Delete</a>


###########################

# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/frogs/new.erb
# Starting at line number: 9... 
...
<a href="/frogs">Cancel</a>


###########################

# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/frogs/index.erb
# Starting at line number: 4... 
...
<h1>Frogs</h1>
<% @frogs.each do |frog| %>
  <p><a href="/frogs/<%= frog.id %>"><%= frog.name %></a></p>
<% end %>
<p><a href="/frogs/new">Create a new frog</a></p>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/pollywog-ranch-associations-ruby-004/app/views/frogs/edit.erb
# Starting at line number: 9... 

    <input type="text" id="name" name="name" placeholder="<%= @frog.name %>">
  <label for="color">Color</label>
  <input type="text" id="color" name="color" placeholder="<%= @frog.color %>">
  <label for="lives">Lives</label>
  <select id="lives" name="pond_id">
    <% @ponds.each do |pond| %>
      <option value="<%= pond.id %>"><%= pond.name %></option>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/songs/show.erb
# Starting at line number: 6... 

  <h1><%= @song.name %></h1>

<h2>Artist: <a href="/artists/<%= @song.artist.slug %>"><%= @song.artist.name %></a></h2>
<p>Genres: 
  <ul>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/songs/new.erb
# Starting at line number: 11... 

    <label>Artist: 
    <input type="text" name="artist_name" id="Artist Name" />
  </label>

  <ul>
    <% @genres.each do |genre| %>
      <li>
        <%= genre.name %><input type="checkbox" name="genre_id[]" id="<%= genre.name %>" value="<%= genre.id %>" />
      </li>
    <% end %>
  </ul>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/songs/index.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/songs/edit.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/genres/show.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/genres/index.erb
# Starting at line number: 2... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/artists/show.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/playlister-sinatra-ruby-004/app/views/artists/index.erb
# Starting at line number: 2... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/fuck_you_rails/weblog/app/views/posts/index.html.erb
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/fuck_you_rails/weblog/app/views/posts/_form.html.erb
# Starting at line number: 7... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/flatiron-kitchen-ruby-004/app/views/recipes/show.html.erb
# Starting at line number: 5... 
...
<ul>
  <% @recipe.ingredients.each do |ingredient| %>
    <li>
      <%= ingredient.name %><form action="/recipes/<%= @recipe.id %>/ingredients/<%= ingredient.id %>/remove" method="POST"><%= token_tag %><input type="submit" value="X" /></form>
    </li>
  <% end %>
</ul>
...
<h3>Add Ingredients to <%= @recipe.name %> Recipe</h3>

<form action="/recipes/<%= @recipe.id %>/ingredients" method="POST">
  <%= token_tag %>
  <% @other_ingredients.each do |ingredient| %>
    <input type="checkbox" name="recipes[checked_ingredients][]" value="<%= ingredient.name %>">
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/flatiron-kitchen-ruby-004/app/views/recipes/index.html.erb
# Starting at line number: 5... 

  <h1>Here's the recipe index page!</h1>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week6/flatiron-kitchen-ruby-004/app/views/ingredients/index.html.erb
# Starting at line number: 5... 

  <h1>Here's the ingredients index page!</h1>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-students-ruby-004/app/views/students/index.erb
# Starting at line number: 2... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-pigeon-ruby-004/app/views/pigeons/index.erb
# Starting at line number: 20... 
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="/pigeons/<%= pigeon.id %>">Show</a></td>
        <td><a href="/pigeons/<%= pigeon.id %>/edit">Edit</a></td>
        <td><a href="/pigeons/<%= pigeon.id %>/destroy">Delete</a></td>        
      </tr>
      <% end %>
    </tbody>
  </table>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-orm-halloween-ruby-004/app/views/houses.erb
# Starting at line number: 8... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-nested-forms-ruby-004/app/views/show_ship.erb
# Starting at line number: 3... 

  <h1><%= @ship.name %></h1>
<ul>
  <% @ship.pirates.each do |pirate| %>
    <li><%= pirate.name %></li>
  <% end %>
</ul>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-nested-forms-ruby-004/app/views/ships.erb
# Starting at line number: 3... 

  <h1>Welcome Aboard, Sonny!</h1>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-nested-forms-ruby-004/app/views/pirate_form.erb
# Starting at line number: 10... 

    <label for="pirate_name">Your Name</label>
  <input type="text" name="pirate[name]" id="pirate_name">

  <label for="ship">Ship:</label>
  <select name="pirate[ship][id]">
    <% Ship.all.each do |ship| %>
      <option id="<%= ship.name %>" value="<%= ship.id %>">
        <%= ship.name %>
      </option>
    <% end %>
  </select>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-nested-forms-ruby-004/app/views/index.erb
# Starting at line number: 7... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/movies/show_genres.erb
# Starting at line number: 5... 
...
<ul>
  <% @movie.genres.each do |genre| %>
    <li>
      <a href="/genres/<%= genre.id %>"><%= genre.name %></a> - (<a href="/genres/<%= genre.id %>/actors">Actors</a>/<a href="/genres/<%= genre.id %>/movies">Movies</a>)
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/movies/show_actors.erb
# Starting at line number: 5... 
...
<ul>
  <% @movie.actors.each do |actor| %>
    <li>
      <a href="/actors/<%= actor.id %>"><%= actor.name %></a> - (<a href="/actors/<%= actor.id %>/genres">Genres</a>/<a href="/actors/<%= actor.id %>/movies">Movies</a>)
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/movies/show.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/movies/new.erb
# Starting at line number: 10... 
  ...
  <label>Select Genre:<br>
    <!-- <input type="text" name="movie[genres]"> -->
    <% @genres.each do |genre| %>
      <input type="checkbox" name="movie[genre_names][]" value="<%= genre.name %>" /><%= genre.name %>
    <% end %>
    <br>
    Other Genres: <input type="text" name="movie[other_genres]">

  </label>
  <br>
  <label>Type Actors (comma separated:<br>
    <input type="text" name="movie[actor_names]">
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/movies/index.erb
# Starting at line number: 5... 
...
<ul>
  ...
  <li>
    ...
    - (<a href="/movies/<%= movie.id %>/genres">Genres</a>/<a href="/movies/<%= movie.id %>/actors">Actors</a>)
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/genres/show_movies.erb
# Starting at line number: 5... 
...
<ul>
  <% @genre.movies.each do |movie| %>
    <li>
      <a href="/movies/<%= movie.id %>"><%= movie.title %></a> - (<a href="/movies/<%= movie.id %>/genres">Genres</a>/<a href="/movies/<%= movie.id %>/actors">Actors</a>)
    </li>
  <% end %>
</ul>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/genres/show_actors.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/genres/index.erb
# Starting at line number: 4... 
...
<ul>  
  ...
  <li>
    ...
    - (<a href="/genres/<%= genre.id %>/movies">Movies</a>/<a href="/genres/<%= genre.id %>/actors">Actors</a>)
  </li>
  <% end %>
</ul>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/checkbox.erb
# Starting at line number: 1... 

  <% @genres.each do |genre| %>
  <input type="checkbox" name="movie[genres][]" value="<%= genre.name %>"><%= genre.name %>
  <br>
<% end %>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/actors/show_movies.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/actors/show_genres.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/actors/show.erb
# Starting at line number: 5... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week5/sinatra-complex-forms-ruby-004/app/views/actors/index.erb
# Starting at line number: 4... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week4/sinatra-messages-ruby-004/views/messages.erb
# Starting at line number: 13... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week3/playlister-generator-ruby-004/lib/views/genres.html.erb
# Starting at line number: 14... 

      <ul>
      
      <!-- sort genres by song count -->
      <% sorted_genres = Genre.all.sort_by { |genre| genre.songs.count } %>
      <!-- List all Genres with song counts -->
      <% sorted_genres.each do |genre| %>
        <li><a href="/genres/<%= genre.url %>"><%= genre.name %></a>(Songs: <%= genre.songs.count %> / Artists: <%= genre.artists.count %>)</li>
      <% end %>

    </ul> 
    <a href="artists.html">Browse by artist</a><br>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week3/playlister-generator-ruby-004/lib/views/genre.html.erb
# Starting at line number: 27... 

      <ul>
      <!-- sort artists by name --> 
      <% sorted_artists = genre.artists.sort_by { |artist| artist.name } %>

      <!-- list all genres of this artist -->
      <% sorted_artists.each do |artist| %>
        <li><a href="../artists/<%= artist.url %>"><%= artist.name %></a>(Song Count: <%= artist.songs.count %>)</li>
      <% end %>


    </ul>
    <a href="../genres.html">Browse by Genre</a><br>
    <a href="../index.html">Back to Index</a>
  </body>
</html>
...
# Starting at line number: 17... 
      ...
      <!-- sort songs alphabetyically by song name -->
      <% sorted_songs = genre.songs.sort_by { |song| song.name } %>

      <!-- List all songs -->
      <% sorted_songs.each do |song| %>
        <li><a href="../songs/<%= song.url %>"><%= song.name %></a></li>
      <% end %>
    </ul> 
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week3/playlister-generator-ruby-004/lib/views/artists.html.erb
# Starting at line number: 15... 

        
      <!-- sort artists alphabetyically by artist name -->
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week3/playlister-generator-ruby-004/lib/views/artist.html.erb
# Starting at line number: 25... 

      <ul>
      <!-- sort genres by popularity --> 
      <% sorted_genres = artist.genres.sort_by { |genre| genre.songs.count } %>

      <!-- list all genres of this artist -->
      <% sorted_genres.each do |genre| %>
        <li><a href="../genres/<%= genre.url %>"><%= genre.name %></a>(Song Count: <%= genre.songs.count %>)</li>
      <% end %>
...
# File: /Users/samschlinkert/Documents/code/flatiron/labs/week3/erb-templating-ruby-004/lib/templates/movie.html.erb
# Starting at line number: 14... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/assessments/rails_assessment/app/views/posts/show.html.erb
# Starting at line number: 9... 
...
# File: /Users/samschlinkert/Documents/code/flatiron/assessments/rails_assessment/app/views/posts/index.html.erb
# Starting at line number: 6... 
